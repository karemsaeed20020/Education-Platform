...
//   };
//   createdAt: string;
//   isCompleted?: boolean; // Added field
// }
...
//   // Add this useEffect for listening to exam updates
//   useEffect(() => {
...
//         "http://localhost:5000/api/exams/published",
//         {
//           credentials: "include",
//         }
//       );
...
//       أدب: { label: "أدب", variant: "success" as const },
...
//           const examStatus = result || exam.isCompleted;
...
//                         <Badge
//                           variant={
//                             examStatus.percentage >= 50 ? "default" : "destructive"
//                           }
//                         >
//                           {examStatus.percentage?.toFixed(1)}%
//                         </Badge>
//                         <span className="text-sm text-gray-600">
//                           تم التقديم في{" "}
//                           {new Date(examStatus.submittedAt).toLocaleDateString(
//                             "ar-EG"
//                           )}
//                         </span>
//                       </div>
...
export default function StudentExamsPage() {
  ...
  const getCategoryBadge = (category: string) => {
    const categoryConfig = {
      ...
      صرف: { label: "صرف", variant: "secondary" as const },
      بلاغة: { label: "بلاغة", variant: "outline" as const },
      أدب: { label: "أدب", variant: "default" as const }, // Changed from 'success' to 'default'
      نصوص: { label: "نصوص", variant: "destructive" as const },
      إملاء: { label: "إملاء", variant: "default" as const },
      اختبار_شامل: { label: "شامل", variant: "secondary" as const },
    };
