...
//       if (formData.avatar?.[0]) payload.append('avatar', formData.avatar[0]);
...
//                           <input type="file" {...register('avatar')} accept="image/*" className="hidden" />
//                         </label>
//                       </div>
//                     </div>
...
//                       <Input type={showPassword ? 'text' : 'password'} {...registerPass('currentPassword')} />
//                       <span
...
//                       </span>
//                       {passwordErrors.currentPassword && <p className="text-red-600 text-sm mt-1">{passwordErrors.currentPassword.message}</p>}
//                     </div>

//                     <div className="flex flex-col relative">
//                       <Label className="mb-1">كلمة المرور الجديدة</Label>
//                       <Input type={showPassword ? 'text' : 'password'} {...registerPass('newPassword')} />
//                       <span
//                         className="absolute left-2 top-9 cursor-pointer"
//                         onClick={() => setShowPassword(!showPassword)}
//                       >
//                         {showPassword ? <EyeOff className="w-4 h-4 text-gray-500" /> : <Eye className="w-4 h-4 text-gray-500" />}
//                       </span>
//                       {passwordErrors.newPassword && <p className="text-red-600 text-sm mt-1">{passwordErrors.newPassword.message}</p>}
//                     </div>

//                     <div className="flex flex-col relative">
//                       <Label className="mb-1">تأكيد كلمة المرور</Label>
//                       <Input type={showPassword ? 'text' : 'password'} {...registerPass('confirmPassword')} />
//                       <span
//                         className="absolute left-2 top-9 cursor-pointer"
//                         onClick={() => setShowPassword(!showPassword)}
//                       >
//                         {showPassword ? <EyeOff className="w-4 h-4 text-gray-500" /> : <Eye className="w-4 h-4 text-gray-500" />}
//                       </span>
//                       {passwordErrors.confirmPassword && <p className="text-red-600 text-sm mt-1">{passwordErrors.confirmPassword.message}</p>}
//                     </div>
