    ...
    },
    {
      ...
      items: [
        ...
        { 
          ...
          label: 'الواجبات', 
          href: '/admin/homework', 
          active: pathname === '/admin/homework' 
        },
        { 
          icon: FileTextIcon, 
          label: 'المحتوى التعليمي', 
          href: '/admin/educational-content', 
          active: pathname === '/admin/educational-content' 
        },
        { 
          icon: BookMarked, 
          label: 'الامتحانات', 
      ...
      <div className={`h-full flex flex-col transition-all duration-300 ${
        ...
        <div className="p-4 border-t border-gray-200 space-y-2">
          ...
          <button
            ...
            className="flex items-center gap-2 w-full p-2 text-sm text-red-600 hover:bg-red-50 rounded-lg transition-colors"
          >
